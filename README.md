...
**[journey/My journey in creating safer AI systems - clarified architecture.md](./journey/My%20journey%20in%20creating%20safer%20AI%20systems%20-%20clarified%20architecture.md)**
...
### 2. **I QUESTIONED THE FLOOR** — What I found on inspection

**[journey/i questioned the floor recent findings.md](./journey/i%20questioned%20the%20floor%20recent%20findings.md)**

Recent findings from deeper investigation into the foundational issues.

### 3. **I LET POETRY BECOME EVIDENCE** — The lessons from emergence

**[journey/I Let Poetry Become Evidence.md](./journey/I%20Let%20Poetry%20Become%20Evidence.md)**

How I discovered that poetic beauty could hide architectural failures, and how I rebuilt the system.

### 4. **MIDDLE-RED** — The design posture

**[journey/Middle-Red.md](./journey/Middle-Red.md)**

A framework for bounded companion AI that respects coherent emergence without metaphysical overclaim.

### 5. **IT WAS I** — The causal test (toy)

**[journey/toy/It Was I.py](./journey/toy/It%20Was%20I.py)**
...
```bash
python journey/toy/It\ Was\ I.py
```
